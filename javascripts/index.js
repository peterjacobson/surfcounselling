...
function toggleCollapse(e) {
  ...
  if (icon.className.match('plus')) {
    ...
    collapsableSection.style.height="auto"
    var fullHeight = collapsableSection.scrollHeight
    collapsableSection.style.height=0
    Velocity(collapsableSection, { height: fullHeight }, { duration: 100, easing: "swing"})
  } else {
    icon.className = icon.className.replace('minus', 'plus')
    Velocity(collapsableSection, { height: 0 }, { duration: 100, easing: "swing"})
  }
}
